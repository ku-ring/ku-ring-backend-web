...
public class ClubCommandService implements ClubSubscriptionUseCase, ClubCreateAdminUseCase {
    ...
    private final BuildingQueryPort buildingQueryPort;
    ...
    public Long createClub(AdminClubCreateCommand command) {
        ...
        Building building = command.buildingId() != null
                ? buildingQueryPort.findById(command.buildingId())
                .orElseThrow(() -> new InvalidStateException(BUILDING_NOT_FOUND))
                : null;
        ...
        Club clubToSave = createClub(command, category, division, building, recruitStartAt, recruitEndAt, applyUrl, iconImagePath, posterImagePath);
    ...
    private static Club createClub(AdminClubCreateCommand command, ClubCategory category, ClubDivision division, Building building, LocalDateTime recruitStartAt, LocalDateTime recruitEndAt, String applyUrl, String iconImagePath, String posterImagePath) {
        return new Club(
                ...
                category, division, building, command.room(),
