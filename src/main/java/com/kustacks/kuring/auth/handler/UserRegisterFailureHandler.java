...
public class UserRegisterFailureHandler implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, Exception failed) throws IOException {
        try {
            String responseToClient = objectMapper.writeValueAsString(new BaseResponse<>(USER_REGISTER_FAIL, null));
