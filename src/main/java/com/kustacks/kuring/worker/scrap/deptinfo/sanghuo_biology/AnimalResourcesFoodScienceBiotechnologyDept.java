...
public class AnimalResourcesFoodScienceBiotechnologyDept extends SanghuoBiologyCollege {
    ...
    public AnimalResourcesFoodScienceBiotechnologyDept(
        ...
        this.staffScrapInfo = new StaffScrapInfo(ANIMAL_RESOURCES.getUrlPrefix(), siteIds);
        this.noticeScrapInfo = new NoticeScrapInfo(ANIMAL_RESOURCES.getUrlPrefix(), 923);
