...
public class NoticeQueryApiV2 {
    ...
    public ResponseEntity<BaseResponse<List<NoticeRangeLookupResponse>>> getNotices(
            ...
            @Parameter(description = "대학원 여부") @RequestParam(name = "is_grad", defaultValue = "false") Boolean isGrad,
        ...
        NoticeRangeLookupCommand command = new NoticeRangeLookupCommand(type, department, important, isGrad, page, size);
